...
- Leading projects on **embedded systems (C Pro, C2, C Basic)** and **internal software solutions** like `Etikettendruck`, `InsightBridge`, and `FieldSync`.  
- Focus areas: **Embedded Linux (V4L2, GStreamer)**, **SvelteKit apps**, **PostgreSQL**, and **workflow automation (ERP + Salesforce)**.  
...
|-----------------------|-----------------------|
| **Languages**         | Python, C, C++, Nim, TypeScript, JavaScript |
| **Frameworks**        | SvelteKit, Node.js, Prisma, Supabase |
| **Embedded Systems**  | V4L2, GStreamer, RAUC, PTXdist, ZynqMP |
| **Databases**         | PostgreSQL, Supabase, InfluxDB |
| **DevOps / Tools**    | Docker, GitHub Actions, Retool, Grafana, Metabase |
| **Cybersecurity**     | Kali Linux, Burp Suite, Nessus, Azure Sentinel |
...
- [Ransomware PoC (C#)](https://youtu.be/dab8pQ5UVjs?si=rTbHbLYjPPyy0hVq)  
...
<div align="center">
  ...
  <a href="https://www.linkedin.com/in/jayesh-kakkad" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0059b3?style=for-the-badge&logo=linkedin&logoColor=white" />
  </a>
